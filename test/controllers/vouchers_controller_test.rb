...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { business_id: @voucher.business_id, code: @voucher.code, discount: @voucher.discount } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { business_id: @voucher.business_id, code: @voucher.code, discount: @voucher.discount } }
